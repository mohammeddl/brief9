                            ...
                            <div class="flex justify-around w-[350px] space-x-1 text-sm text-gray-500">
                              ...
                              <form action="../controllers/project.control.php" method="POST">
                                ...
                                <button type="submit" name="delete_project">
                                  ...
                                  <button href="../controllers/project.control.php">
                              ...
                              <button>
                            <button href="kanban.php" class="inline-flex items-center px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-800 text-sm font-medium rounded-md">
                            add task
                          </button>
                              </div>
                            </div>
  ...
  <div  class="fixed inset-0 z-50 overflow-auto bg-black bg-opacity-50" id="fromHidden" >
            <div class="modal-content bg-white mx-auto my-8 p-8 w-1/2">
                ...
                <form action="../controllers/project.control.php" method="POST">
                    ...
                    <input type="text" id="id" type="hidden" value="<?php $_SESSION['user_id']?>" name="idUsser">
